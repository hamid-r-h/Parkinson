...
for fold, (train_index, test_index) in enumerate(kfold.split(audio_list,labels)):
    ...
    data_train = [audio_list[i] for i in train_index]
    data_test = [audio_list[i] for i in test_index]
